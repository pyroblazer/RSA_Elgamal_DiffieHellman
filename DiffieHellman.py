...
def generate_secret_both(prime_number, prime_base, private_a, private_b):
    prime_number = int(prime_number)
    prime_base = int(prime_base)
    private_a = int(private_a)
    private_b = int(private_b)
    public_a = prime_base**private_a % prime_number
    public_b = prime_base**private_b % prime_number
...
# prime_base = generate_prime_less_than_n(bit, prime_number)
# print("prime_base = ",prime_base)

# private_a = number.getRandomInteger(bit)
# print("a = ",private_a)
# private_b = number.getRandomInteger(bit)
# print("b = ", private_b)
# secret = generate_secret_both(prime_number, prime_base, private_a, private_b)
# print(secret)
